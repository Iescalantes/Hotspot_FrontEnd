...
export class GestionListaPeticionesComponent implements AfterViewInit {
  ...
  /**
   * Función que carga la información de los festivales no confirmados aún en la vista.
   */
  ...
  /**
   * Función que guarda en el localStorage el ID del festival al que se le pincha.
   */
  async Guardian() {
  ...
  /**
   * Función que bloquea el acceso a usuarios que no deban acceder a esa vista.
   */
  async RolCheckAdmin() {
